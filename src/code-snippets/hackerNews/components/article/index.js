            ...
            {displayArticle?
                <React.Fragment>
                    ...
                    <div className="article-stats">
                        ...
                        <span className="article-stats-item article-link">{getTimestamp(article.time)}</span><Pipe pipeClass={"stats-pipe"}/>
                        <span className="article-stats-item article-link">hide</span><Pipe pipeClass={"stats-pipe"}/>
                        <span className="article-stats-item article-link">{comments? comments.length : 0} comments</span>
                    </div>
                </React.Fragment>
            :
                ""
